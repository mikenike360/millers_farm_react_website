...
export default function Home() {
  ...
  return (
    <div className="flex flex-col">
      ...
      {/* Call to Action */}
      <section className="bg-gradient-to-r from-teal-600 to-blue-400 text-gray-900 py-10 text-center">
      ...
      <section className="bg-gradient-to-r from-teal-600 to-blue-400 py-10 px-4">
